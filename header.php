...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base_url; ?>css/theme-style.min.css?v=<?php echo $asset_version; ?>">
    <link rel="stylesheet" href="<?php echo $base_url; ?>style.css?v=<?php echo $asset_version; ?>">
    <?php if (basename($_SERVER['SCRIPT_NAME']) == 'index.php' || basename($_SERVER['PHP_SELF']) == 'index.php'): ?>
        <link rel="stylesheet" href="<?php echo $base_url; ?>css/home-cinematic.css?v=<?php echo $asset_version; ?>">
                ...
                <div class="header-row">
                    ...
                    <div class="main-menu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo $base_url; ?>meet-the-team.php">Team</a></li>
    ...
    <div class="responsive-menu offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvas">
        ...
        <div class="offcanvas-body main-menu">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link menu-toggle" href="#">Procedures <i><img class="svg" src="<?php echo $base_url; ?>images/menu-down-arrow.svg" alt="Down Arrow"></i></a>
                    <ul class="dropdown-menu" style="display: none">
                        <li class="sub-dropdown">
                            <a class="dropdown-item" href="#">Breast Cancer <i><img class="svg" src="<?php echo $base_url; ?>images/menu-down-arrow.svg" alt="Down Arrow"></i></a>
                        ...
                        <li class="sub-dropdown">
                            <a class="dropdown-item" href="#">Breast Cosmetic <i><img class="svg" src="<?php echo $base_url; ?>images/menu-down-arrow.svg" alt="Down Arrow"></i></a>
                            <ul class="sub-dropdown-menu" style="display: none">
                                <li><a class="dropdown-item" href="<?php echo $base_url; ?>procedures/breast-cosmetic/fat-transfer-lipomodelling.php">Fat Transfer or Lipomodelling</a></li>
                                <li><a class="dropdown-item" href="<?php echo $base_url; ?>procedures/breast-cosmetic/breast-augmentation.php">Breast Augmentation</a></li>
                                <li><a class="dropdown-item" href="<?php echo $base_url; ?>procedures/breast-cosmetic/mastopexy-breast-lift.php">Mastopexy - Breast Lift</a></li>
